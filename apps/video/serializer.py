...
class VideoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Video
        fields = ["id", "video_title", "video_description","video_host_url", "video_host_id","video_host_thumbnail_url","created_at","video_owner", "notes_count", "notes","category","tags_count", "tags"]
